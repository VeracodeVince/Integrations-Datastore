Feature: APIs for working with SCM organizations
    ...
    Scenario Outline: Storing an organization
        ...
        And database contains an organization with scmId: <scmId>, orgIdentity: <orgIdentity>, team: <teamInDB>, cxFlowUrl: <cxFlowUrl>, cxFlowConfig: <cxFlowConfigInDB>, tokenId: <tokenId>
        Examples:
            | scmId | orgIdentity | teamInRequest | cxFlowConfigInRequest | teamInDB     | cxFlowConfigInDB | tokenId | cxFlowUrl            |
            # Updating an existing org. Null request fields are ignored during the update.
            | 1     | myOrg1      | newTeam       | newConfig             | newTeam      | newConfig        | 1       | http://example.com/1 |
            | 1     | myOrg1      | <null>        | newConfig             | initialTeam1 | newConfig        | 1       | http://example.com/1 |
            | 1     | myOrg1      | newTeam       | <null>                | newTeam      | initialConfig1   | 1       | http://example.com/1 |
            | 1     | myOrg1      | <null>        | <null>                | initialTeam1 | initialConfig1   | 1       | http://example.com/1 |
            # Creating a new org.
            | 1     | newOrg      | newTeam       | newConfig             | newTeam      | newConfig        | <null>  | <null>               |
            | 1     | newOrg      | <null>        | newConfig             | <null>       | newConfig        | <null>  | <null>               |
            | 1     | newOrg      | newTeam       | <null>                | newTeam      | <null>           | <null>  | <null>               |
            | 1     | newOrg      | <null>        | <null>                | <null>       | <null>           | <null>  | <null>               |
