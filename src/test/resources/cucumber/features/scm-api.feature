Feature: SCM CRUD APIs
    ...
    Scenario Outline: Getting SCM details by a valid SCM base url
        ...
        Examples:
            ...
            | github-get-test.com      | ff718111a48803ba73566 | 7a260229fc9adf2c34f5e06e2b665f0f06094666 |
            | gitlab-get-test.com      | ff718111a48803ba73562 | 7a260229fc9adf2c34f5e06e2b665f0f06094662 |

    Scenario: Getting SCM details by an invalid SCM base url
        Given data base does not contains "unknown.com" base url
        When API client calls the `get scm` API for "unknown.com"
